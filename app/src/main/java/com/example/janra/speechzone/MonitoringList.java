...
public class MonitoringList extends AppCompatActivity {
    ...
    public void del2(View v){
        ...
        //sp2.edit().remove("stud2").commit();
    }
    public void list1(View v){
        SharedPreferences sp1 = getSharedPreferences("Pref1",MODE_PRIVATE);
        String name1 = sp1.getString("stud1",null);
        if(name1 == null){
            Toast.makeText(this, "NO STUDENT 1",Toast.LENGTH_SHORT).show();
        }
        else{
            Intent i = new Intent(this, sessions_std1.class);
            startActivity(i);
        }
    ...
    public void list2(View v){
        ...
        String name2 = sp2.getString("stud2",null);
        if(name2 == null){
            Toast.makeText(this, "NO STUDENT 2",Toast.LENGTH_SHORT).show();
        }
        else{
            Intent i = new Intent(this, sessions_std2.class);
            startActivity(i);
        }
